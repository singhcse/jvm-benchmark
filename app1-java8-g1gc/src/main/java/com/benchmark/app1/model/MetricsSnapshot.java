...
public class MetricsSnapshot {
    ...
    private MetricsSnapshot(Builder b) {
        ...
        this.appLabel = b.appLabel;
        this.port = b.port;
        this.startupMs = b.startupMs;
        this.heapUsedMb = b.heapUsedMb;
        this.heapMaxMb = b.heapMaxMb;
        this.nonHeapUsedMb = b.nonHeapUsedMb;
        this.threadCount = b.threadCount;
        this.virtualThreads = b.virtualThreads;
        this.gcPauseMaxMs = b.gcPauseMaxMs;
        this.gcPauseAvgMs = b.gcPauseAvgMs;
        this.gcCollectionCount = b.gcCollectionCount;
        this.gcType = b.gcType;
